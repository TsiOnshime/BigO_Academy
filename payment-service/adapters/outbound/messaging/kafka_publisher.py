...
class KafkaEventPublisher(EventPublisherPort):
    ...
    def publish_student_payment_status_changed(self, payment: StudentPayment, old_status: str):
    ...
    def publish_teacher_payment_recorded(self, payment: TeacherPayment) -> None:
    ...
    def publish_teacher_payment_status_changed(self, payment: TeacherPayment, old_status: str) -> None:
...
class ConsoleEventPublisher(EventPublisherPort):
    ...
    def publish_student_payment_status_changed(self, payment: StudentPayment, old_status: str) -> None:
        self._publish("payment.student.status_changed", {
            "paymentId": str(payment.id),
            "oldStatus": old_status,
            "newStatus": payment.status.value
